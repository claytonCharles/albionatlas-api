...
Baseado nos dados coletados do jogo pelo projeto [Albion Data Online](https://github.com/ao-data/albiondata-client).
Futuramente pretendo fazer um client baseado no mesmo também, para estudo.
